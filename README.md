...
<head>
    ...
    <title>Xuân Bính Ngọ 2026 - Gửi Trọn Yêu Thương</title>
...
<body>
    ...
    <div class="ui-layer" id="main-ui">
        <div class="glass-card" id="main-card">
            <p class="sub-text" id="lunar-year">Xuân Ất Tỵ 2025</p>
            ...
            <button class="btn-action" id="btn-trigger" onclick="startLeap()">MỞ CỬA 2026</button>
            <br>
            <button class="btn-action" id="btn-next" onclick="showLoveMessage()">GỬI TRỌN YÊU THƯƠNG →</button>
        </div>
    </div>
    ...
    <div id="wish-overlay">
        ...
        <div class="btn-group" id="wish-btns">
            <button class="btn-action" style="background: var(--gold);" onclick="location.reload()">QUAY LẠI</button>
            <button class="btn-action" onclick="openSearch()">GỬI LỜI</button>
        </div>
        ...
        <form id="my-form" action="https://formspree.io/f/xjgkvnak" method="POST" class="search-container">
            ...
            <button type="submit" class="btn-action" style="padding: 10px 20px; font-size: 0.8rem;">GỬI</button>
        </form>
    ...
    <script>
        ...
        function startLeap() {
            ...
            setTimeout(() => {
                document.getElementById('lunar-year').innerText = "Mừng Xuân Bính Ngọ 2026";
        ...
        function showLoveMessage() {
            ...
            const message = "Mình chúc cô gái của mình luôn cutee xinh gái và luôn yêu thương chính bản thân mình hơn. Biết tự lo mỗi buổi sáng, biết làm việc nhà giúp cho bố mẹ. Hãy luôn hạnh phúc bên gia đình và tôn trọng những người thân trong gia đình. Phải luôn tiến bước trên con đường học tập, phấn đấu cho tương lai và đầu tư vào việc học thật tốt nhé. Nhớ nhé: việc học là việc cả đời, còn tình yêu bây giờ chưa giúp được gì nhiều đâu. Vậy nên Kim Ngân yêu dấu hãy tiến bước và yêu thương bản thân mình nhiều lên nhé. Aye ❤️";
        ...
        async function handleSubmit(event) {
          ...
          fetch(event.target.action, {
            ...
            if (response.ok) {
              status.innerHTML = "Cảm ơn Kim Ngân, mình đã nhận được rồi! ❤️";
              status.style.display = "block";
              form.style.display = "none";
            } else {
              status.innerHTML = "Lỗi! Bạn nhớ vào Gmail xác nhận Formspree đã nhé.";
              status.style.display = "block";
            }
          });
        }
